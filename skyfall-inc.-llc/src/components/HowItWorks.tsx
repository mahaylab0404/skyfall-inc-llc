...
const steps = [
  {
    ...
    description: "We learn about the space, goals, equipment needs, and type of setup the customer wants.",
    icon: Phone
  },
  {
    title: "Plan the system",
    description: "Skyfall.inc LLC helps plan the room layout, irrigation, lighting, ventilation, and automation needs.",
    icon: Layout
  },
  {
    title: "Build or support the setup",
    description: "The setup is organized around clean installation, reliable equipment control, and a more consistent indoor environment.",
    icon: Settings
  }
];
    ...
    <section id="how-it-works" className="py-12 md:py-20 bg-black px-6 border-t border-white/5 relative">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 md:mb-12">
          <span className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-brand-sage font-bold text-glow-green">Our Process</span>
          <h2 className="text-2xl md:text-5xl font-medium tracking-tight text-white mt-3 md:mt-4 italic">How It Works</h2>
        </div>
