...
export default function BrandMission() {
  const values = [
    {
      title: "Integrity",
      description: "We provide high-quality equipment and professional automation setups with unmatched reliability.",
      icon: Heart
    },
    {
      title: "Innovation",
      description: "Pushing the boundaries of technology with custom-built smart grow room controllers.",
      icon: Lightbulb
    },
    {
      title: "Precision",
      description: "Mastering controlled cultivation environments through precision irrigation and ventilation.",
      icon: Sprout
    }
  ];
    ...
    <section id="about" className="py-12 md:py-20 bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-10 md:mb-16">
          ...
          >
            From Seed <br className="hidden" /> to Sky
          </motion.h2>
          ...
          >
            ...
            <p className="text-base md:text-xl text-zinc-100 font-light leading-snug italic tracking-tight mb-6 md:mb-8 px-2 md:px-0">
              "Skyfall.inc LLC is more than just indoor grow room setups. We are professional designers of controlled cultivation environments, built around innovation, precision, and performance."
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-12 md:mt-16">
          {values.map((value, index) => (
            ...
            >
              ...
              <p className="text-[12px] md:text-[13px] text-zinc-500 leading-relaxed font-light">
                {value.description}
              </p>
            </motion.div>
          ))}
