      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-start">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-brand-sage font-bold text-glow-green">Connect</span>
            <h2 className="text-2xl md:text-5xl font-medium tracking-tight text-white mt-3 md:mt-4 mb-4 md:mb-6 leading-tight capitalize italic">Contact Skyfall.inc LLC</h2>
            <p className="text-[14px] md:text-base text-zinc-400 mb-8 md:mb-10 max-w-lg leading-relaxed font-light italic">
              Tell us about your space, equipment needs, and project goals. Skyfall.inc LLC will follow up about custom grow room setups, irrigation layouts, lighting and ventilation, or smart automation systems.
            </p>
            ...
            <div className="space-y-4 md:space-y-6">
              <div className="flex gap-4 items-center group">
                ...
                <div className="text-sm">
                  <p className="text-zinc-500 uppercase tracking-widest text-[8px] md:text-[9px] mb-0.5 font-bold">Headquarters</p>
                  <a 
              ...
              <div className="flex gap-4 items-center group">
                ...
                <div className="text-sm">
                  <p className="text-zinc-500 uppercase tracking-widest text-[8px] md:text-[9px] mb-0.5 font-bold">Email Us</p>
              ...
              <div className="flex gap-4 items-center group">
                ...
                <div className="text-sm">
                  <p className="text-zinc-500 uppercase tracking-widest text-[8px] md:text-[9px] mb-0.5 font-bold">Call Team</p>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="space-y-1.5 md:space-y-2">
                  <label className="text-[8px] md:text-[9px] uppercase tracking-[0.2em] text-zinc-500 ml-1 font-bold">Name</label>
                  <input 
                    type="text" 
                    name="name"
                    required
                ...
                <div className="space-y-1.5 md:space-y-2">
                  <label className="text-[8px] md:text-[9px] uppercase tracking-[0.2em] text-zinc-500 ml-1 font-bold">Phone Number</label>
                  <input 
                    type="tel" 
                    name="phone"
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="space-y-1.5 md:space-y-2">
                  <label className="text-[8px] md:text-[9px] uppercase tracking-[0.2em] text-zinc-500 ml-1 font-bold">Email Address</label>
                  <input 
                    type="email" 
                    name="email"
                    required
                ...
                <div className="space-y-1.5 md:space-y-2">
                  <label className="text-[8px] md:text-[9px] uppercase tracking-[0.2em] text-zinc-500 ml-1 font-bold">Project Type</label>
                  <div className="relative">
                    ...
                    >
                      <option className="bg-zinc-900 text-white">Indoor Grow Room Setup</option>
                      <option className="bg-zinc-900 text-white">Grow Room Automation</option>
                      <option className="bg-zinc-900 text-white">Irrigation System Design</option>
                      <option className="bg-zinc-900 text-white">Environmental Control/HVAC</option>
                      <option className="bg-zinc-900 text-white">Project Consultation</option>
                    </select>
              ...
              <div className="space-y-1.5 md:space-y-2">
                <label className="text-[8px] md:text-[9px] uppercase tracking-[0.2em] text-zinc-500 ml-1 font-bold">Project Details</label>
                <textarea 
                  name="message"
                  required
                  rows={4}
                  ...
                  placeholder="Tell us about your space, equipment needs, and project goals..."
                ></textarea>
              </div>
