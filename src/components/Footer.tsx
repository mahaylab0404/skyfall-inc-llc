      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-10 md:gap-12">
          ...
          <div className="flex flex-col items-center md:items-end gap-3 md:gap-4 text-center md:text-right">
            ...
            <div className="flex gap-6 md:gap-8">
              <a href="#" className="text-[8px] md:text-[9px] uppercase tracking-[0.2em] md:tracking-[0.3em] text-zinc-700 hover:text-emerald-400 transition-colors font-bold">Privacy Policy</a>
              <a href="#" className="text-[8px] md:text-[9px] uppercase tracking-[0.2em] md:tracking-[0.3em] text-zinc-700 hover:text-emerald-400 transition-colors font-bold">Terms of Service</a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 md:mt-16 pt-6 md:pt-8 border-t border-white/5 text-center">
          <p className="text-[8px] md:text-[9px] uppercase tracking-[0.3em] md:tracking-[0.5em] text-zinc-800 font-black px-4">
            Missouri's Premium Grow Room Automation Specialists
          </p>
        </div>
      </div>
    </footer>
