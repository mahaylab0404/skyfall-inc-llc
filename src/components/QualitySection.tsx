  ...
  return (
    <section className="py-12 md:py-20 bg-black px-6 overflow-hidden relative">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center">
        ...
        >
          <span className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-brand-sage font-bold text-glow-green">Standard of Excellence</span>
          <h2 className="text-2xl md:text-5xl font-medium tracking-tight text-white mt-3 md:mt-4 mb-4 md:mb-6 leading-tight italic">Built for Quality, Control, and Reliability.</h2>
          
          <div className="space-y-4 md:space-y-6">
            <p className="text-zinc-400 text-[13px] md:text-[14px] font-light italic leading-relaxed max-w-lg">
              "We focus on clean layouts, reliable equipment planning, and professional indoor cultivation spaces that stand the test of time."
            </p>
            ...
            <div className="pt-4 md:pt-6 border-t border-white/5">
              <div className="text-zinc-500 text-[9px] md:text-[10px] uppercase tracking-widest font-bold mb-2 md:mb-3 flex items-center gap-3">
                <div className="w-6 md:w-8 h-[1px] bg-brand-sage"></div> Feature Details
              </div>
              <p className="text-zinc-400 text-[12px] md:text-sm font-light leading-relaxed">
                Clean room layout, irrigation planning, and equipment organization are the foundations of every Skyfall build.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden silver-border aspect-[4/3] group relative">
            ...
            <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
              <div className="glass-card silver-border px-4 py-3 md:px-6 md:py-4 rounded-xl md:rounded-2xl backdrop-blur-md">
                <p className="text-[9px] md:text-[10px] text-white uppercase tracking-widest font-bold mb-0.5 md:mb-1">Observation</p>
                <p className="text-[11px] md:text-[13px] text-zinc-300 font-light italic">Clean room layout & professional irrigation planning.</p>
              </div>
            </div>
          </div>
