...
const galleryItems = [
  {
    title: "Integrated Grow Setup",
    description: "Lighting and ventilation setup for optimal environmental control in custom Missouri facilities.",
    image: "/indoor-cultivation-room-grow-setup-missouri.png.png",
  },
  {
    title: "Irrigation Systems",
    description: "Precision drip irrigation and clean plumbing layouts for reliable plant health.",
    image: "/custom-grow-room-irrigation-system-missouri.png.png",
  },
  {
    title: "Custom Room Buildouts",
    description: "Industrial-grade indoor cultivation spaces designed for maximum efficiency.",
    image: "/skyfall-inc-custom-grow-room-st-louis-mo.png.png",
  }
];
    ...
    <section id="gallery" className="py-12 md:py-20 bg-[#050505] px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-10 md:mb-12 text-center max-w-2xl mx-auto">
          <span className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-brand-sage font-bold text-glow-green">Portfolio Preview</span>
          <h2 className="text-2xl md:text-4xl font-medium tracking-tight text-white mt-3 md:mt-4 italic">Facility Showcase</h2>
        </div>
